#!/bin/bash
# ==========================================================================
# Cenário C: 20% de perda / 100 ms de delay
...
echo "==========================================="
echo "        INICIANDO CENÁRIO C"
echo "   (20% loss / 100ms delay)"
echo "==========================================="
...
echo "[2] Aplicando restrições: 100ms de delay | 20% de loss"
...
tcpdump -i eth0 -w /app/dados_e_logs/pcap/cenarioC_tcp.pcap &
TCPDUMP_PID=$!
sleep 1
...
tcpdump -i eth0 -w /app/dados_e_logs/pcap/cenarioC_rudp.pcap &
TCPDUMP_PID=$!
sleep 1
...
echo ""
echo "==========================================="
echo "  Cenário C finalizado com sucesso."
echo "  Capturas salvas:"
echo "    - cenarioC_tcp.pcap"
echo "    - cenarioC_rudp.pcap"
echo "==========================================="
